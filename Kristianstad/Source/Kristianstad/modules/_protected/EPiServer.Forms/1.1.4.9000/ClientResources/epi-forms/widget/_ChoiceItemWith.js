...
// epi-addons
    ...
    return declare([ChoiceItem, _UtilityMixin, Evented], {
        ...
        _addExtendedWidget: function (/*Object*/item) {
            ...
            when(this.getInstanceFromType(this.extendedWidgetType, { readOnly: item.readOnly }), lang.hitch(this, function (/*Object*/extendedWidget) {
