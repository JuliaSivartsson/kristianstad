...
(function ($) {
    ...
    $.extend(true, epi.EPiServer.Forms, {
        Utils: {
            ...
            getFormStepBlock: function (blockName, $workingForm) {
                ...
                return $(".Form__Element [data-epiforms-element-name='" + blockName + "']", $workingForm);
            },
        ...
        Validators: {
            ...
            "EPiServer.Forms.Implementation.Validation.CaptchaValidator": {
                ...
                _refreshCaptcha: function ($element) {
                    ...
                    var $captchaFormElement = $element.hasClass("FormCaptcha") ? $element : $element.parents(".FormCaptcha"),
                        $captchaImg = $captchaFormElement.find(".FormCaptcha__Image"),
                        $captchaInput = $captchaFormElement.find(".FormTextbox__Input");
    ...
    epi.EPiServer.Forms.init = function () {
        ...
        $(document).ready(function () {
            ...
            $('.EPiServerForms input.FormTextbox__Input,.FormChoice__Input.FormChoice__Input--Checkbox,.FormRange__Input,.FormTextbox__Input.FormUrl__Input,.FormChoice__Input.FormChoice__Input--Radio,.FormTextbox__Input.FormCaptcha__Input.FormHideInSummarized').on('keydown', function _onKeyDown(e) {
                var $workingForm = _utilsSvc.getWorkingFormFromInnerElement(this),  
                    keyCode = e.keyCode,
                    $nextStepButton = $(".Form__NavigationBar .Form__NavigationBar__Action.btnNext", $workingForm), // Access the nextStep Button.

                    // retrieve step sections visible on screen that contains a submit button.
                    $buttonSubmitSections = $('.Form__Element.FormSubmitButton', $workingForm).parent(".FormStep").filter(function (index) {
            ...
            function _formSubmissionHandler(/*Event*/e) {
                ...
                $.when(showSummarizedData(workingFormInfo, data)).then(function (userAcceptToSubmit) {
                    ...
                    for (var fieldName in data) {
                        ...
                        if (!$validatedEle.parents(".FormStep:first").hasClass("hide")) {
                        ...
                        if (returnedResult.IsSuccess === true) {
                            ...
                            if (isFinalizedSubmission == false) {
                                ...
                                _utilsSvc.raiseFormsEvent(workingFormInfo, {
                                    type: 'formsSubmitted',
                                    formData: formData, isFinalizedSubmission: false,
                            ...
                            _utilsSvc.raiseFormsEvent(workingFormInfo, {
                                type: 'formsSubmitted',
                                formData: formData, isFinalizedSubmission: true,
                                isSuccess: returnedResult.IsSuccess,
                                returnedResult: returnedResult
                            });
                            ...
                            if (returnedResult.RedirectUrl) {
                                ...
                                showFormMessage(workingFormInfo, returnedResult.Message, isFinalizedSubmission);
                            }
                        }
            ...
            function showFormMessage(workingFormInfo, message, isFinalizedSubmission) {
                if (!workingFormInfo) {
                    return;
                }
                ...
                if (message) {
                    ...
                    $messagePanel.removeClass("Form__Warning__Message").addClass("hide").html("");
                }

                if (isFinalizedSubmission == true) {
                    $messagePanel.removeClass("Form__Warning__Message").addClass("Form__Success__Message");
                }
            };
            ...
            // scan all Form__Element inside the $container, take input data from users (from input control)
            function collectInputData($container, excludeCallback) {
                ...
                // Get data from Data elements (like textbox/textarea/selection/listbox values). We will ignore element having FormStep or Form__Element--NonData
                $(".Form__Element, .Form__CustomElement", $container).not(".FormStep,.Form__Element--NonData").each(function (index, el) {
                    $el = $(el);
                    ...
                    if (($el.parents(".FormStep:first").hasClass("hide"))) {   
                        return;
                    }
            ...
            function _refreshCaptchaElement($container) {
                epi.EPiServer.Forms.Validators["EPiServer.Forms.Implementation.Validation.CaptchaValidator"]._refreshCaptcha($(".Form__Element.FormCaptcha", $container));
            }
